...
| File | Purpose |
| :--- | :--- |
| **`main.py`** | The main executable Python script. It queries LeetCode's GraphQL API to fetch your submission history, filters for accepted status, maps LeetCode language names to correct file extensions (e.g. C++ ➜ `.cpp`, Python3 ➜ `.py`), and saves them locally. |
...
### 1. Requirements
The script uses the standard `requests` library.
...
Run the script python interpreter:
